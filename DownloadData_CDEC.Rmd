...
#write_csv(Temp_E_F_Raw_df, "data_raw/watertemp/Temp_E_F_raw.csv") #write data
saveRDS(Temp_E_F_Raw_df, "data_raw/watertemp/Temp_E_F_raw.rds", compress = "xz") #write rds
...
write_csv(Temp_E_C_Raw_df, "data_raw/watertemp/Temp_E_C_raw.csv") #write data
saveRDS(Temp_E_C_Raw_df, "data_raw/watertemp/Temp_E_C_raw.rds") #write rds
...
write_csv(Temp_H_F_Raw_df, "data_raw/watertemp/Temp_H_F_raw.csv") #write data
saveRDS(Temp_H_F_Raw_df, "data_raw/watertemp/Temp_H_F_raw.rds", compress = "xz") #write rds
...
write_csv(Temp_H_C_Raw_df, "data_raw/watertemp/Temp_H_C_raw.csv") #write data
saveRDS(Temp_H_C_Raw_df, "data_raw/watertemp/Temp_H_C_raw.rds") #write rds
...
Temp_all_std <- rename(Temp_all_std,
  Station =station,
  Datetime = datetime)
saveRDS(Temp_all_std, "data_raw/watertemp/Std/Temp_all_std.rds", compress = "xz") # Write rds
...
for (name in levels(Temp_all_std$station)) {
  ...
  fn=paste('data_raw/watertemp/Std/Individual/',name, "_std_sin.csv", sep="")
...
# Write data
saveRDS(temp_H_f, "data_raw/watertemp/Temp_all_H.rds", compress = "xz") # Write rds
# write_csv(temp_H_f, "data_raw/watertemp/Temp_all_H.csv") # write csv
