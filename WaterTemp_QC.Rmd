...
#### Read files ###
temp_H_0 <- readRDS("data_raw/watertemp/Temp_all_H.rds")
...
rm(temp_q2_a)
saveRDS(temp_q3, "data_raw/watertemp/temp_q3.rds")
temp_q3 <- readRDS("data_raw/watertemp/temp_q3.rds")
```
...
saveRDS(temp_flags, "data_clean/watertemp/Temp_flagged.rds", compress = "xz")
#write_csv(temp_flags, "TempData/QC/Temp_flagged.csv")

# Combined files - filtered
saveRDS(temp_final, "data_clean/watertemp/Temp_filtered.rds", compress = "xz")
...
write_csv(Flagged_stations, "data_clean/watertemp_data_flagged_percentages.csv")
