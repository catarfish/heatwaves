...
temp_appt<-temp_max_raw%>%
  ...
  mutate(temp_appt_l1=lag(temp_appt, 1, order_by=date),
         ...
         heatwave_99=if_else(temp_appt>temp_appt_q99 & temp_appt_l1>temp_appt_q99 & temp_appt_l2>temp_appt_q99, TRUE, FALSE),
         heatwave_95=if_else(temp_appt>temp_appt_q95 & temp_appt_l1>temp_appt_q95 & temp_appt_l2>temp_appt_q95, TRUE, FALSE),
         heatwave_90=if_else(temp_appt>temp_appt_q90 & temp_appt_l1>temp_appt_q90 & temp_appt_l2>temp_appt_q90, TRUE, FALSE))%>%
  ungroup()%>%
