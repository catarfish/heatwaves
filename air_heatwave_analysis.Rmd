...
temp_appt<-temp_appt_raw%>%
  rowwise()%>%
  mutate(temp_appt_q99=quantile(temp_appt_raw$temp_appt[temp_appt_raw$doy%in%date_slider(date) & temp_appt_raw$major_city==major_city], 0.99),
         temp_appt_q95=quantile(temp_appt_raw$temp_appt[temp_appt_raw$doy%in%date_slider(date) & temp_appt_raw$major_city==major_city], 0.95),
         temp_appt_q90=quantile(temp_appt_raw$temp_appt[temp_appt_raw$doy%in%date_slider(date) & temp_appt_raw$major_city==major_city], 0.90))%>%
  ungroup()%>%
  group_by(major_city)%>%
