...
# Temp cutoffs
```{r}
cutoff_range<-range(c(filter(air_cutoffs, quantile==95)$cutoff, filter(w_cutoffs, quantile==95)$cutoff))

p1_air<-ggplot(filter(air_cutoffs, quantile==95), aes(x=date_, y=cutoff, color=Location))+
