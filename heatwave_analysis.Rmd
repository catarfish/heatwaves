...
ggplot(filter(duration, duration>0)) + 
...
ggsave(plot=p, file="figs/water heatwave results.png", height=6, width=10)
...
ggsave(plot=p_int, file="figs/water_intensity.png", height=8, width=10)
