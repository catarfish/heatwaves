...
temp_quantiles = dailytemp %>%
  ...
  mutate(temp_max_l1 = lag(temp_max, 1, order_by = date),
         ...
         heatwave_99=if_else((temp_max>temp_max_q99 & temp_max_l1>temp_max_q99 & temp_max_l2>temp_max_q99) | (temp_max>temp_max_q99 & temp_max_ln1>temp_max_q99 & temp_max_ln2>temp_max_q99) | (temp_max>temp_max_q99 & temp_max_ln1>temp_max_q99 & temp_max_l1>temp_max_q99), 1L, 0L),
         heatwave_95=if_else((temp_max>temp_max_q95 & temp_max_l1>temp_max_q95 & temp_max_l2>temp_max_q95) | (temp_max>temp_max_q95 & temp_max_ln1>temp_max_q95 & temp_max_ln2>temp_max_q95) | (temp_max>temp_max_q95 & temp_max_ln1>temp_max_q95 & temp_max_l1>temp_max_q95), 1L, 0L),
         heatwave_90=if_else((temp_max>temp_max_q90 & temp_max_l1>temp_max_q90 & temp_max_l2>temp_max_q90) | (temp_max>temp_max_q90 & temp_max_ln1>temp_max_q90 & temp_max_ln2>temp_max_q90) | (temp_max>temp_max_q90 & temp_max_ln1>temp_max_q90 & temp_max_l1>temp_max_q90), 1L, 0L),
         # # min
...
# cat's code -----
# slight difference in number of heatwaves 
heat_duration <- temp_quantiles %>%
  dplyr::select(Station, date, fMonth, WY, Year, Season, temp_max, temp_max_q95, heatwave_95, heatwave_95_intensity) %>%
...
duration <- heat_duration %>%
  ...
  mutate(duration = max(counter),
         meantemp = mean(temp_max, na.rm = TRUE),
         meanintensity = heatwave_95_intensity, na.rm = TRUE) %>%
  slice(n()) %>%
  ungroup() %>%
  filter(duration>0) %>%
...
```{r}
# save(cutoffs, heatwave_sum_max, heatwave_sum_max_year, heatwave_dur_year, file = here::here("data_clean/water_temp_data_for_plots.Rdata"))
```
